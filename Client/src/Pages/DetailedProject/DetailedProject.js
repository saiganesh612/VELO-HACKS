          ...
          <div className="row">
            <div className="col-lg-8 entries">
              <article className="entry entry-single">
                <div className="entry-img" align="center">
                  <iframe width="100%" height="550" src="https://www.youtube.com/embed/0LsxkQ28UkI" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
                ...
                <div className="entry-meta">
                  <ul>
                    <li className="d-flex align-items-center">
                      <img style={{ height: "30px", margin: "10px", borderRadius: "15px" }} src={project?.profileImage} alt="profile" />
                      {project?.username}
                    </li>
                ...
                <div className="entry-content">
                  ...
                  <b>Project Detailed Explanation</b>
                  <p>
