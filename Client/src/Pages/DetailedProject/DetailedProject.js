          ...
          <div class="col-lg-8 entries">
            ...
            <article class="entry entry-single">
              ...
              <div class="entry-meta">
                <ul>
                  <li class="d-flex align-items-center"><img style={{height:"30px",margin:"10px",borderRadius:"15px"}} src={project?.profileImage} /> {project?.username}</li>
                  <li class="d-flex align-items-center"><i class="bi bi-person"></i> {project?.theme}</li>
              ...
              <div class="entry-content">
                <blockquote>
                  ...
                  {project?.team?.map(team=>{
                      return(
                         <a style={{textTransform:"capitalize",textDecoration:"none",color:"black"}}  href={team.linkedinUrl}> <li >{team.name}</li> </a>
                      )
                  })}
                  </ol>
                </blockquote>
